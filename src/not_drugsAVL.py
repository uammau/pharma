...
from prescribersAVL import prescribersAVL
...
class drugsAVLNode(object):
    ...
    def __init__(self, parent, k, last_prescriber, drug_cost):
        ...
        self.drug_cost = drug_cost # Initializes cost with the original cost
    ...
    def insert(self, node):
        ...
        if node.key == self.key:
            ...
            self.num_prescriber += self.prescribers_list.insert(node.last_prescriber)
