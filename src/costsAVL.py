...
class costsAVLNode(object):
    """A node in the AVL tree."""
 
    def __init__(self, parent, k, drug_data):
        """Creates a node.
        ...
        self.drugs_list = prescribersAVL()
        self.drug_data = drug_data
        self.num_drugs = self.drugs_list.insert(drug_data)
    ...
    def insert(self, node):
        ...
        if node.key == self.key:
            ...
            self.num_drugs += self.drugs_list.insert(node.drug_data)
    ...
    def writeReverseOrderRecursive(self, outputFile):
        if (self == None):
            return
        else:
            if (self.right != None):
                self.right.writeReverseOrderRecursive(outputFile)
                
##            self.drugs_list.root.writetoFileReverseOrder(outputFile)
            self.drugs_list.root.writetoFileInOrder(outputFile)
            
            if (self.left != None):
                self.left.writeReverseOrderRecursive(outputFile)
                
    def writeReverseOrder(self, outputFile):
        if (self == None):
            return
        else:
            ...
            # Calls print Reverse Order
            self.writeReverseOrderRecursive(file)
...
class costsAVL(object):
    ...
    def insert(self, k, drug_data):
        ...
        """
        val = 1
        node = costsAVLNode(None, k, drug_data)
    ...
    def delete(self, k):
        ...
        if node is self.root:
            pseudoroot = costsAVLNode(None, 0)
